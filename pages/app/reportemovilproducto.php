	                ...
	                <div class="box-body">
	                  ...
	                  <table id="examplenada" class="table table-bordered table-hover">
	                    <?php
							...
							if(isset($_GET['movil_sup']))
							{
								if ($_GET['movil_sup'] == '1') 
								{
									//$usuario_sup = $_GET['usuario'];
									$idpromotor = $_GET['idpromotor'];
									$json = reporteproductos_sup_noti($fecha, $conexion, $dia, $dni, $idpromotor);
								}
							}
							else
							{
									  ...
									  <div class='modal fade' role='dialog' id='FmyModal".$i."'>
										  <div class='modal-dialog modal-lg' role='document'>
										    <div class='modal-content' id='Freportes".$i."'>
										    	...
										    	<div style='background-color: red;'><button type='button' class='close' data-dismiss='modal'>&times;</button></div>
										    </div>
										  </div>
									  </div>
									  ";
