	                  	...
	                  	<div class="box-tools pull-right">
	                  		...
	                  		<table>
	                  			<tr>
	                      			...
	                      			<td style="width: 40px;">
	                      				<button type="button" class="btn btn-success btn-sm daterange pull-right" data-toggle="tooltip" title="Tiempos y Traslados" onclick="exportexcel_alen()">
	                    ...
	                    <?php
							...
							{ 
								...
								{	
									...
									echo "<tr><td>
										 <table class='tabla table table-bordered table-hover' >
											<thead>
											<tr>
												<th style='width=200px' colspan='5'>".$json[$i]['nombre']." ".$fecha."</th>
												 <td></td>
												  <td></td>
												   <td></td>
								...
								if(!empty($json[$i]['salida']))
					            {
					              ...
					              $h_traslado = restatime($json[$i]['entrada'], $json[$aux]['salida']);
					            }
					            else
					            {
					            	$h_traslado = ""; 
