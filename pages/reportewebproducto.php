                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td style="width: 230px;" align="right">
                                                        <b>Cadena: </b>
                                                        <select id="buscarCadena"  class="form-control" name="buscarCadena" onchange="getValue()">
                                                    ...
                                                    <td style="width: 230px;" align="right" >
                                                        <b>Buscar tienda ult. visita:</b>
                                                        <div>
                                                            <input class="form-control" id="searchcliente" type="text" size='27px' onkeyup="doCLiente()" />
                                                        </div>
                                                    </td>
                                                    <td style="width: 230px;" align="right">
                                                        <b>Buscar tienda/nombre ruta:</b>
                                                        <input class="form-control" id="searchTerm" type="text" size='27px' onkeyup="doSearch()" />
                                                    </td>
                                                    <td align="right">
                                                        <b>Inicio:</b>
                                                        <div>
                                                            <input type="date" style='width: 150px;' class="form-control pull-right" name="fecha_inicio" id="fecha_inicio" value="<?php echo date('Y-m-d', strtotime($fecha)); ?>">
                                                        </div>
                                                    </td>
                                                    <td  align="right">
                                                        <b>Fin:</b>
                                                        <div>
                                                            <input type="date" style='width: 150px;' class="form-control pull-right" name="fecha_fin" id="fecha_fin" value="<?php echo date('Y-m-d', strtotime($fecha_fin)); ?>">
                                                        </div>
                                                    </td>
                                                    <td style="width: 50px;">
                                                        &nbsp;
                                                    ...
                                                    <td style="width: 40px;">
                                                        ...
                                                        <div class="row top-buffer">
                                                            <button type="button" class="btn btn-yahoo btn-sm daterange pull-right" data-toggle="tooltip" title="Descargar Fotografias" id="fotografias" onclick="exportphotos()">
                                                                <i class="fa fa-file-photo-o"></i></button>
                                                        </div>
                                                    </td>
                                                </tr>
	                ...
	                <div class="box-body" >
	                	<div class="table-responsive" id='clienteultima'>
                            ...
                            <div style="overflow:auto;">
                                    <table id="datos" class="table table-responsive table-bordered table-striped">
                                <thead>
                                    <tr>
	                    ...
	                    <?php
                                    ...
                                    $json = reporteproductos_alen($fecha,$fecha_fin, $conexion, $dia, $dni);
                                ...
                                $sqlExtra= "SELECT
                                                                    ...
                                                                    Where
                                                                        ...
                                                                        inv.fecha = CONVERT (date, '".$json[$i]['FechaVisita']."', 103) And
                                                                        inv.Id_usuario = '".$usr."'
                                                                    Group By
                                                                        inv.Id_cliente,
                                                                        inv.fecha,
											...
											$newdate=str_replace("/", "-",$json[$i]['FechaVisita']);	
											$newdate2=str_replace("/", "-",$json[$i]['chkDate']);		
											$ymd = strtotime($newdate);
											$ymd2=strtotime($newdate2);
                                if($ymd==$ymd2)	    
                                {
                               ...
                               // $progreso=$json[$i]['progreso'];
                                ...
                                echo "<tr>
                                        ...
                                        <td>".$adicional."</td>
                                        <td style='text-overflow:ellipsis; white-space:nowrap'>".$json[$i]['FechaVisita']."</td>					                    
