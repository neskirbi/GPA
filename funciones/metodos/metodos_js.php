...
function actualiza(id,idobjeto)
	...
	function exportexceldeta2()
  {
   ...
   var foto=document.getElementById('fotosn').checked;
    ...
    var link="../reportesexcel/reporteexceldetallepen2.php?fecha="+fecha+"&perio="+peri
  ...
  function exportexceldeta4()
  {
   ...
   var foto=document.getElementById('fotosn').checked;
	...
	var link="../reportesexcel/reporteexceldetallepen4.php?fecha="+fecha+"&perio="+peri
    +"&super="+superv+"&foto="+seleccionado;
    console.log(link);
   ...
   function exportexceldetacomp()
  {
    ...
    document.location.target = "_blank";
    document.location.href="../reportesexcel/reporteexceldetallepencomp.php?fecha="+fecha; 
  }
  function popup(ruta)
  {
