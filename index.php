                ...
                if(!isset($acta['1'])){
                    ...
                    if(isset($actas_status['1'])){
                      ...
                      <?php
                          ...
                          ?>                    
                          <img src="imagen/fileclip.png" id="img1<?php echo $users[$i]['id'];?>" onclick="DescargarActa('<?php echo $acta['1'];?>');" style="cursor: pointer;" width="30px">
                          <?php
                        }
                      }else{
                        ?>                    
                ...
                if(!isset($acta['2'])){
                    ...
                    if(isset($actas_status['2'])){
                      ...
                      <?php
                          ...
                          ?>                    
                          <img src="imagen/fileclip.png" id="img1<?php echo $users[$i]['id'];?>" onclick="DescargarActa('<?php echo $acta['2'];?>');" style="cursor: pointer;" width="30px">
                          <?php
                        }
                      }else{
                        ?>                    
                ...
                if(!isset($acta['3'])){
                    ...
                    if(isset($actas_status['3'])){
                      ...
                      <?php
                          ...
                          ?>                    
                          <img src="imagen/fileclip.png" id="img1<?php echo $users[$i]['id'];?>" onclick="DescargarActa('<?php echo $acta['3'];?>');" style="cursor: pointer;" width="30px">
                          <?php
                        }
                      }else{
                        ?>                    
